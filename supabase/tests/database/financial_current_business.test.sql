...
select public.set_admin_booking_financial_total('be641000-0000-4000-8000-000000000002','appointment','ee641000-0000-4000-8000-000000000001',30);
select public.set_admin_booking_financial_total('be641000-0000-4000-8000-000000000002','appointment','ee641000-0000-4000-8000-000000000002',40);
...
insert into financial_test_results select throws_ok($$select public.create_admin_financial_entry('be641000-0000-4000-8000-000000000002','reservation','ce641000-0000-4000-8000-000000000001','income',40,null,null,'2030-01-01','paid')$$,'23514','financial_exceeds_remaining','B reservation cannot duplicate canonical receipt');
