  ...
  function submit() {
    ...
    startSaving(async () => {
      ...
      const result = !editing && complementaryGroup && (!recurring || intent === "complementary")
        ? await createManualReservation({ repeatCount: recurring && intent === "complementary" ? (recurrenceType === "count" ? repeatCount : null) : undefined, intent, primary: includesPrimary ? input : null, complementary: includesComplementary && complementaryOptionId ? { optionId: complementaryOptionId, occupancyMode: complementaryGroup.occupancyMode, date, startTime: complementaryGroup.occupancyMode === "time_slot" ? (intent === "combined" ? selectedStartTime : complementaryStartTime) : null, endTime: complementaryGroup.occupancyMode === "time_slot" ? (intent === "combined" ? primaryEndTime : complementaryEndTime) : null } : null, customerName, customerWhatsapp })
        : editing && appointment
