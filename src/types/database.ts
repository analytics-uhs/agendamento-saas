...
export interface Database {
  public: {
    Tables: {
      ...
      purchases: {
        Row: { id: string; business_id: string; status: "draft" | "confirmed"; supplier_name: string | null; purchase_date: string; notes: string | null; total_amount: number; confirmed_at: string | null; created_by: string | null } & Timestamps;
        Insert: never; Update: never; Relationships: [];
      };
      purchase_items: {
